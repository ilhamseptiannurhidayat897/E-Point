...
<div class="bg-white rounded-2xl shadow-lg border border-gray-100 max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-4 p-6 border-b">
        ...
        <div class="flex-1">
            <h2 class="font-semibold text-gray-800">{{ $bk->nama }}</h2>
            <p class="text-sm text-gray-500">Bimbingan Konseling</p>
        </div>
    ...
    <div class="divide-y">
        ...
        <div class="flex justify-between items-center px-6 py-4">
            ...
            <span class="font-medium text-gray-800">{{ $bk->nama }}</span>
        </div>

        <div class="flex justify-between items-center px-6 py-4">
            <span class="text-sm text-gray-500">Nomor Induk Pegawai</span>
            <span class="font-medium text-gray-800">{{ $bk->nip ?? '-' }}</span>
        </div>

        <div class="flex justify-between items-center px-6 py-4">
            <span class="text-sm text-gray-500">Role</span>
            <span class="font-medium text-gray-800">Bimbingan Konseling</span>
        </div>
    ...
    <div class="px-6 pt-6">
        <div class="bg-gradient-to-r from-primary/5 to-purple-600/5 
                    border border-primary/20 rounded-xl p-5 mb-6">
