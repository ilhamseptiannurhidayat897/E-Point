        ...
        <table class="w-full">
            <thead class="bg-gradient-to-r from-primary/5 to-purple-600/5">
                <tr>
                    ...
                    <th class="text-left px-6 py-4 text-sm font-semibold text-gray-700">Jenis Prestasi</th>
                    ...
                    <td colspan="5" class="px-6 py-16 text-center">
                        <div class="flex flex-col items-center justify-center">
                            <div class="bg-gray-100 p-6 rounded-2xl mb-4">
                                <i class="fas fa-trophy text-gray-400 text-5xl"></i>
                            </div>
                            <p class="text-gray-500 font-medium mb-2">Belum ada data prestasi</p>
                            <p class="text-sm text-gray-400">Mulai input prestasi siswa</p>
                        </div>
                    </td>
                </tr>
                @endforelse
