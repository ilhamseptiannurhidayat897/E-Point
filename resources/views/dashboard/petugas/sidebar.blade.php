<aside id="sidebar"
    ...
    <div class="flex items-center gap-3 p-5 border-b border-gray-200 flex-shrink-0">
        ...
        <div class="flex-1 min-w-0">
            ...
            <p class="text-xs text-gray-500 truncate">Petugas Panel</p>
        </div>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto p-4 space-y-1 custom-scrollbar">
        ...
        <a href="{{ route('dashboard.petugas') }}"
           class="sidebar-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
            ...
            <i class="fas fa-home w-5 text-center flex-shrink-0 {{ request()->routeIs('dashboard.petugas') ? 'text-primary' : 'text-gray-500' }}"></i>
            <span class="truncate">Dashboard</span>
            @if(request()->routeIs('dashboard.petugas'))
        ...
        <a href="{{ route('inputpelanggaran.create') }}"
           class="sidebar-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
                  {{ request()->routeIs('inputpelanggaran.create') 
                      ? 'bg-gradient-to-r from-primary/10 to-purple-600/10 text-primary border-l-4 border-primary shadow-sm' 
                      : 'text-gray-700 hover:bg-gray-100 hover:text-primary hover:translate-x-1 hover:shadow-sm' }}">
            <i class="fas fa-exclamation-triangle w-5 text-center flex-shrink-0 {{ request()->routeIs('inputpelanggaran.create') ? 'text-primary' : 'text-gray-500' }}"></i>
        ...
        <a href="{{ route('inputprestasi.create') }}"
           class="sidebar-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
                  {{ request()->routeIs('inputprestasi.create') 
                      ? 'bg-gradient-to-r from-primary/10 to-purple-600/10 text-primary border-l-4 border-primary shadow-sm' 
                      : 'text-gray-700 hover:bg-gray-100 hover:text-primary hover:translate-x-1 hover:shadow-sm' }}">
            <i class="fas fa-star w-5 text-center flex-shrink-0 {{ request()->routeIs('inputprestasi.create') ? 'text-primary' : 'text-gray-500' }}"></i>
        ...
        <a href="{{ route('inputpelanggaran.index') }}"
           class="sidebar-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
                  {{ request()->routeIs('inputpelanggaran.index') 
                      ? 'bg-gradient-to-r from-primary/10 to-purple-600/10 text-primary border-l-4 border-primary shadow-sm' 
                      : 'text-gray-700 hover:bg-gray-100 hover:text-primary hover:translate-x-1 hover:shadow-sm' }}">
            <i class="fas fa-list w-5 text-center flex-shrink-0 {{ request()->routeIs('inputpelanggaran.index') ? 'text-primary' : 'text-gray-500' }}"></i>
        ...
        <a href="{{ route('inputprestasi.index') }}"
           class="sidebar-menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
                  {{ request()->routeIs('inputprestasi.index') 
                      ? 'bg-gradient-to-r from-primary/10 to-purple-600/10 text-primary border-l-4 border-primary shadow-sm' 
                      : 'text-gray-700 hover:bg-gray-100 hover:text-primary hover:translate-x-1 hover:shadow-sm' }}">
            <i class="fas fa-medal w-5 text-center flex-shrink-0 {{ request()->routeIs('inputprestasi.index') ? 'text-primary' : 'text-gray-500' }}"></i>
