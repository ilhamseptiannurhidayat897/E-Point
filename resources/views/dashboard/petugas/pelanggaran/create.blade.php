...
<div class="mb-6">
    <div class="flex items-center mb-4">
        <a href="{{ route('pelanggaran.index') }}" class="text-gray-500 hover:text-primary mr-3 transition-colors">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Isi form berikut untuk menambahkan jenis pelanggaran baru</p>
        </div>
    </div>
</div>
    ...
    <div class="flex">
        ...
        <div class="ml-3">
            ...
            <p class="mt-1 text-sm text-green-700">
                Pastikan nama pelanggaran jelas dan poin bernilai positif. Data ini akan menjadi referensi untuk pencatatan pelanggaran siswa.
            </p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow overflow-hidden border border-gray-100">
    <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-green-50 to-emerald-50">
        <div class="flex items-center">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-800">Form Pelanggaran</h2>
                <p class="text-sm text-gray-500 mt-1">Lengkapi data jenis pelanggaran dengan benar</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('pelanggaran.store') }}" method="POST" class="p-6 md:p-8">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all @error('nama_pelanggaran') border-red-300 @enderror"
                               required>
                    </div>
                ...
                <div>
                    <label for="poin" class="block text-sm font-medium text-gray-700 mb-2">
                        Poin Pelanggaran <span class="text-red-500">*</span>
                    </label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Nilai negatif (misal: -5, -10, -15)</p>
                    @error('poin')
                        <span class="text-red-500 text-xs mt-1 flex items-center">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
