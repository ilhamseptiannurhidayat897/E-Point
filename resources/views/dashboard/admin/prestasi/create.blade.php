...
<div class="bg-gradient-to-r from-primary to-purple-800 rounded-xl p-4 md:p-6 lg:p-8 mb-6 md:mb-8 text-white shadow-lg">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2">Tambah Prestasi Siswa</h1>
            <p class="text-sm md:text-base text-purple-200">Isi formulir untuk menambahkan data prestasi siswa</p>
        </div>
...
<div class="bg-white rounded-xl shadow-sm p-4 md:p-6 lg:p-8 border border-gray-100">
    <div class="mb-6">
        ...
        <p class="text-sm md:text-base text-gray-600">Lengkapi data prestasi siswa dengan benar</p>
    </div>
    ...
    <form method="POST"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <!-- JENIS PRESTASI -->
            <div class="md:col-span-2">
                <label for="jenis_prestasi_id" class="block text-sm font-medium text-gray-700 mb-2">
                ...
                >
                    ...
                    @foreach($jenis as $j)
                        <option value="{{ $j->id }}" {{ old('jenis_prestasi_id') == $j->id ? 'selected' : '' }}>
                            {{ $j->nama }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="md:col-span-2">
                <label for="foto" class="block text-sm font-medium text-gray-700 mb-2">
                    Foto Prestasi <span class="text-gray-400 text-xs">(Opsional)</span>
                </label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        Pastikan data siswa dan jenis prestasi yang dipilih sudah benar. Foto prestasi bersifat opsional namun sangat disarankan untuk dokumentasi.
                    </div>
                </div>
            </div>
        </div>
