...
<div class="bg-gradient-to-r from-primary to-purple-800 rounded-xl p-4 md:p-6 lg:p-8 mb-6 md:mb-8 text-white shadow-lg">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2">Tambah Jenis Pelanggaran</h1>
            <p class="text-sm md:text-base text-purple-200">Isi formulir untuk menambahkan jenis pelanggaran baru</p>
        </div>
...
<div class="bg-white rounded-xl shadow-sm p-4 md:p-6 lg:p-8 border border-gray-100">
    <div class="mb-6">
        ...
        <p class="text-sm md:text-base text-gray-600">Lengkapi data jenis pelanggaran dengan benar</p>
    </div>
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        Pastikan nama pelanggaran dan poin yang dimasukkan sudah benar. Poin akan dikurangi dari total poin siswa.
                    </div>
                </div>
            </div>
        </div>
