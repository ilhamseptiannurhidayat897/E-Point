...
<div class="bg-gradient-to-r from-primary to-purple-800 rounded-xl p-4 md:p-6 lg:p-8 mb-6 md:mb-8 text-white shadow-lg">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2">Edit Jenis Pelanggaran</h1>
            <p class="text-sm md:text-base text-purple-200">Perbarui informasi jenis pelanggaran yang ada</p>
        </div>
...
<div class="bg-white rounded-xl shadow-sm p-4 md:p-6 lg:p-8 border border-gray-100">
    <div class="mb-6">
        ...
        <p class="text-sm md:text-base text-gray-600">Perbarui data jenis pelanggaran dengan informasi terbaru</p>
    </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" 
                           ...
                           class="w-full pl-10 pr-4 py-2.5 md:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm md:text-base"
                           placeholder="Masukkan poin pengurangan">
                </div>
                @error('poin')
                    <p class="mt-2 text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        Pastikan nama pelanggaran dan poin yang diperbarui sudah benar. Perubahan akan mempengaruhi perhitungan poin siswa.
                    </div>
                </div>
            </div>
        </div>
