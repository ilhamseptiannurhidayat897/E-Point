...
<div class="bg-gradient-to-r from-primary to-purple-800 rounded-xl p-8 mb-8 text-white shadow-lg">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-3xl font-bold mb-2">Edit Data Wali Kelas</h1>
            <p class="text-green-100">Perbarui informasi wali kelas yang ada</p>
        </div>
...
<div class="bg-white rounded-xl shadow overflow-hidden border border-gray-100 max-w-4xl mx-auto">
    ...
    <form action="{{ route('walikelas.update', $walikelas->id) }}" method="POST" class="p-6">
        @csrf
        @method('PUT')
