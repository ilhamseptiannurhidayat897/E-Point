...
<div class="bg-gradient-to-r from-primary to-purple-800 rounded-xl p-4 md:p-6 lg:p-8 mb-6 md:mb-8 text-white shadow-lg">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2">Data Pelanggaran</h1>
            <p class="text-sm md:text-base text-purple-200">Kelola data pelanggaran siswa</p>
        </div>
...
<div class="bg-white rounded-xl shadow border border-gray-100 overflow-hidden">
    <div class="px-4 md:px-6 py-3 md:py-4 border-b border-gray-100">
        <h2 class="text-base md:text-lg font-semibold text-gray-800">Daftar Pelanggaran Siswa</h2>
    </div>
                ...
                <tbody class="divide-y divide-gray-100" id="pelanggaranTableBody">
                    ...
                    <tr>
                        <td colspan="9" class="px-4 md:px-6 py-8 md:py-12 text-center">
                            ...
                            <h3 class="text-base md:text-lg font-medium text-gray-900 mb-2">Belum ada data pelanggaran</h3>
                            <p class="text-sm md:text-base text-gray-500 mb-3 md:mb-4">Mulai dengan menambahkan data pelanggaran baru</p>
                            @if(in_array(auth()->user()->role, ['admin','petugas']))
                            <a href="{{ route('pelanggaran.create') }}" class="bg-primary hover:bg-purple-700 text-white px-4 py-2 rounded-lg inline-flex items-center text-sm md:text-base">
                                <svg class="w-4 h-4 md:w-5 md:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                                </svg>
                                Tambah Pelanggaran
