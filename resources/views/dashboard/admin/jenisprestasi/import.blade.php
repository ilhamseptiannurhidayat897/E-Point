...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-md border border-gray-50 p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 mb-1">Import Jenis Prestasi</h1>
                <p class="text-sm text-gray-400">Unggah file Excel untuk menambahkan data jenis prestasi secara massal.</p>
            </div>
            <div class="bg-gradient-to-br from-indigo-100 to-purple-100 p-4 rounded-xl shadow-sm">
                <i class="fas fa-trophy text-indigo-500 text-2xl"></i>
            </div>
        </div>
    </div>
        ...
        <div class="p-6">
            ...
            <form method="POST"
                ...
                <div class="flex justify-end">
                    <button type="submit"
                            class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary to-purple-500 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105">
