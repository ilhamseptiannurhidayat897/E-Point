...
<div class="bg-gradient-to-r from-primary to-purple-800 rounded-xl p-8 mb-8 text-white shadow-lg">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <p class="text-white-100">Kelola data kelas, jurusan, dan tingkat</p>
        </div>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr>
                    <td colspan="5" class="px-6 py-12 text-center">
                        ...
                        <a href="{{ route('datakelas.create') }}"                class="w-full md:w-auto bg-primary text-white hover:bg-gray-50 px-4 md:px-6 py-2 md:py-3 rounded-lg font-semibold inline-flex items-center justify-center transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-sm md:text-base">
