...
<div class="bg-gradient-to-r from-primary to-purple-800 rounded-xl p-8 mb-8 text-white shadow-lg">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-3xl font-bold mb-2">Edit Data Kelas</h1>
            <p class="text-green-100">Perbarui informasi kelas yang ada</p>
        </div>
...
<div class="bg-white rounded-xl shadow overflow-hidden border border-gray-100">
    ...
    <form method="POST" action="{{ route('datakelas.update', $kelas) }}" class="p-6">
        @csrf
        @method('PUT')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select id="jurusan" name="jurusan" 
                        ...
                        <option value="TO" {{ old('jurusan', $kelas->jurusan) == 'TO' ? 'selected' : '' }}>Teknik Otomotif (TO)</option>
                        <option value="TJKT" {{ old('jurusan', $kelas->jurusan) == 'TJKT' ? 'selected' : '' }}>Teknik Jaringan Komputer & Telekomunikasi (TJKT)</option>
        ...
        <div class="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div id="preview" class="text-lg font-bold text-primary">{{ $kelas->nama_kelas }}</div>
        </div>
