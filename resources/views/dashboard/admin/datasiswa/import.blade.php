...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-md border border-gray-50 p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 mb-1">Import Data Siswa</h1>
                <p class="text-sm text-gray-400">Unggah file Excel untuk menambahkan data siswa secara massal.</p>
            </div>
            <div class="bg-gradient-to-br from-indigo-100 to-purple-100 p-4 rounded-xl shadow-sm">
                <i class="fas fa-user-graduate text-indigo-500 text-2xl"></i>
            </div>
        </div>
    </div>
