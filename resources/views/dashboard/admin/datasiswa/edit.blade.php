...
<div class="bg-gradient-to-r from-primary to-purple-800 rounded-xl p-4 md:p-6 lg:p-8 mb-6 md:mb-8 text-white shadow-lg">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2">Edit Data Siswa</h1>
            <p class="text-sm md:text-base text-purple-200">Perbarui informasi siswa yang ada</p>
        </div>
...
<div class="bg-white rounded-xl shadow-sm p-4 md:p-6 lg:p-8 border border-gray-100">
    <div class="mb-6">
        ...
        <p class="text-sm md:text-base text-gray-600">Perbarui data siswa dengan informasi terbaru</p>
    </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select id="kelas_id" 
                        ...
                        @foreach ($kelas as $k)
                            <option value="{{ $k->id }}" {{ old('kelas_id', $datasiswa->kelas_id) == $k->id ? 'selected' : '' }}>{{ $k->nama_kelas }}</option>
                        @endforeach
                    </select>
                    <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-6">
            ...
            <div class="relative">
                ...
                <textarea id="alamat" 
                          ...
                          placeholder="Masukkan alamat lengkap">{{ old('alamat', $datasiswa->alamat) }}</textarea>
            </div>
            @error('alamat')
                <p class="mt-2 text-sm text-red-600 flex items-center">
                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        Pastikan data yang diperbarui sudah benar dan sesuai dengan data resmi. NIS harus unik dan tidak boleh sama dengan siswa lain.
                    </div>
                </div>
            </div>
        </div>
