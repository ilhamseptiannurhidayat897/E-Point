...
<div class="bg-gradient-to-r from-primary to-purple-800 rounded-xl p-4 md:p-6 lg:p-8 mb-6 md:mb-8 text-white shadow-lg">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2">Data Siswa</h1>
            <p class="text-sm md:text-base text-purple-200">Kelola data siswa di sekolah</p>
        </div>
...
<div class="bg-white rounded-xl shadow border border-gray-100 overflow-hidden">
    <div class="px-4 md:px-6 py-3 md:py-4 border-b border-gray-100">
        <h2 class="text-base md:text-lg font-semibold text-gray-800">Daftar Siswa</h2>
    </div>
            ...
            <table class="w-full min-w-full">
                <thead class="bg-gray-50 border-b border-gray-200 sticky top-0 z-10">
                    <tr>
                        ...
                        <th class="px-3 md:px-6 py-3 md:py-4 text-left text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">NIS</th>
                        <th class="px-3 md:px-6 py-3 md:py-4 text-left text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">Nama</th>
                        <th class="px-3 md:px-6 py-3 md:py-4 text-left text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">JK</th>
                        <th class="px-3 md:px-6 py-3 md:py-4 text-left text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">Kelas</th>
                        <th class="px-3 md:px-6 py-3 md:py-4 text-left text-xs font-semibold text-gray-600 uppercase whitespace-nowrap">Wali Kelas</th>
                ...
                <tbody class="divide-y divide-gray-100" id="siswaTableBody">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-3 md:px-6 py-3 md:py-4">
                            ...
                            @else
                            <span class="inline-flex items-center px-2 md:px-3 py-1 rounded-full text-xs font-medium bg-pink-100 text-pink-800">
                                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z"/>
                                </svg>
                                P
                        ...
                        <td class="px-3 md:px-6 py-3 md:py-4 text-sm text-gray-900 whitespace-nowrap">
                            <span class="px-2 md:px-3 py-1 bg-gray-100 rounded-full text-xs font-medium">{{ $item->kelas->nama_kelas }}</span>
                        </td>
                        <td class="px-3 md:px-6 py-3 md:py-4 text-sm text-gray-600 whitespace-nowrap">
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="px-4 md:px-6 py-8 md:py-12 text-center">
                            <svg class="w-12 h-12 md:w-16 md:h-16 text-gray-300 mx-auto mb-3 md:mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                            </svg>
                            <h3 class="text-base md:text-lg font-medium text-gray-900 mb-2">Belum ada data siswa</h3>
                            <p class="text-sm md:text-base text-gray-500 mb-3 md:mb-4">Mulai dengan menambahkan siswa baru</p>
                            <a href="{{ route('datasiswa.create') }}" class="bg-primary hover:bg-purple-700 text-white px-4 py-2 rounded-lg inline-flex items-center text-sm md:text-base">
                                <svg class="w-4 h-4 md:w-5 md:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                                </svg>
                                Tambah Siswa
