...
<div class="mb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Perbarui informasi siswa yang ada</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-4">
        <div class="flex items-center justify-between mb-2">
            ...
            <span id="progress-percentage" class="text-sm font-medium text-primary">100%</span>
        </div>
        <div class="w-full bg-gray-200 rounded-full h-2">
            <div id="progress-bar" class="bg-primary h-2 rounded-full transition-all duration-300" style="width: 100%"></div>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow overflow-hidden border border-gray-100">
    ...
    <form id="student-form" action="{{ route('datasiswa.update', $siswa->id) }}" method="POST" class="p-6 md:p-8">
        @csrf
        @method('PUT')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea id="alamat" 
                                  ...
                                  class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all resize-none @error('alamat') border-red-300 @enderror">{{ old('alamat', $siswa->alamat) }}</textarea>
                    </div>
                    @error('alamat')
                        <span class="text-red-500 text-xs mt-1 flex items-center">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-end sm:space-x-3 space-y-3 sm:space-y-0 pt-6 border-t border-gray-200">
            ...
            <button type="submit" 
                ...
                <span id="submit-text">Update Data</span>
    ...
    <div class="flex">
        ...
        <div class="ml-3">
            ...
            <div class="mt-2 text-sm text-blue-700">
                <ul class="list-disc list-inside space-y-1">
                    <li>Pastikan NIS yang dimasukkan unik dan belum terdaftar oleh siswa lain</li>
